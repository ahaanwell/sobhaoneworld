          ...
          <div className="lg:col-span-3 bg-white rounded-2xl shadow-xl border border-[#e8ddd0] p-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                {errors.loanAmount && (
                  <p className="mt-1.5 text-xs text-[#ca9c20] font-sans">{errors.loanAmount}</p>
                )}
              ...
              <div>
                ...
                {errors.interestRate && (
                  <p className="mt-1.5 text-xs text-[#ca9c20] font-sans">{errors.interestRate}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.tenure && (
                  <p className="mt-1.5 text-xs text-[#ca9c20] font-sans">{errors.tenure}</p>
                )}
                ...
                <div className="mt-6 space-y-3">
                  {["Loan amount", "Interest rate", "Tenure in years"].map((item, i) => (
                    <div key={i} className="flex items-center gap-3">
                      <div className="w-6 h-6 rounded-full bg-[#f0ebe3] flex items-center justify-center text-[#ca9c20] text-xs font-bold font-sans">
                        {i + 1}
                      </div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#ca9c20] flex items-center justify-center">
